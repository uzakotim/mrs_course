...
[ -e ~/task_03_swarm/simulation/user_ros_workspace/devel/setup.bash ] && source ~/task_03_swarm/simulation/user_ros_workspace/devel/setup.bash
...
export ROS_WORKSPACES="$ROS_WORKSPACES /opt/mrs/mrs_workspace ~/task_03_swarm/simulation/user_ros_workspace"
